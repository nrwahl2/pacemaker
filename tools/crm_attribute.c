...
build_arg_context(pcmk__common_args_t *args, GOptionGroup **group) {
    ...
    const char *description = "Examples:\n\n"
                              ...
                              "Query the value of the '" PCMK__OPT_CLUSTER_DELAY
                                "' cluster option:\n\n"
                              "\tcrm_attribute --type crm_config --name "
                                PCMK__OPT_CLUSTER_DELAY " --query\n\n"
                              "Query value of the '" PCMK__OPT_CLUSTER_DELAY
                                "' cluster option and print only the value:\n\n"
                              "\tcrm_attribute --type crm_config --name "
                                PCMK__OPT_CLUSTER_DELAY " --query --quiet\n\n";
