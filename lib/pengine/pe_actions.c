                            ...
                            const pcmk_scheduler_t *scheduler)
{
    ...
    // PCMK__OPT_PRIORITY_FENCING_DELAY is disabled
            ...
            pcmk_scheduler_t *scheduler)
{
    ...
    if (scheduler->priority_fencing_delay > 0
            ...
            /* It's a suitable case where PCMK__OPT_PRIORITY_FENCING_DELAY
             * applies. At least add PCMK__OPT_PRIORITY_FENCING_DELAY field as
             * an indicator.
             */
        && (priority_delay
            ...
            || g_hash_table_lookup(stonith_op->meta,
                                   PCMK__OPT_PRIORITY_FENCING_DELAY) != NULL)) {

            /* Add PCMK__OPT_PRIORITY_FENCING_DELAY to the fencing op even if
            ...
            g_hash_table_insert(stonith_op->meta,
                                strdup(PCMK__OPT_PRIORITY_FENCING_DELAY),
                                delay_s);
    }
