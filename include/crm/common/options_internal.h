...
enum pcmk__opt_flags {
    ...
    pcmk__opt_advanced   = (1 << 3),    //!< Advanced use only
    pcmk__opt_generated  = (1 << 4),    //!< Generated by Pacemaker
    pcmk__opt_deprecated = (1 << 5),    //!< Deprecated
    pcmk__opt_fencer     = (1 << 6),    //!< In fencer metadata
};
...
int pcmk__output_fence_attrs(pcmk__output_t *out, const char *name,
                             const char *desc_short, const char *desc_long,
                             bool all);
