...
static const pcmk__cluster_option_t options[] = {
    /* name, old name, type, context,
     * allowed values,
     ...
     */
    {
        "PCMK_" PCMK__ENV_DEBUG, NULL, "select", pcmk__option_local,
        "yes, no, " CRM_SYSTEM_MCP ", pacemaker-attrd, pacemaker-based, "
            "pacemaker-controld, pacemaker-execd, pacemaker-fenced, "
            "pacemaker-schedulerd",
        "no", NULL,
        N_("Whether to send debug severity messages to the detail log."),
        N_("This may be set for all subsystems (yes or no) or for specific "
            "(comma-separated) subsystems."),
    },
    {
        "PCMK_" PCMK__ENV_LOGFACILITY, NULL, "select", pcmk__option_local,
        PCMK__VALUE_NONE ", daemon, user, local0, local1, local2, local3, "
            "local4, local5, local6, local7",
        "daemon", NULL,
        N_("Log facility for syslog or systemd-journald"),
        N_("Enable logging via the system log or journal, using the specified "
            "log facility. Messages sent here are of value to all Pacemaker "
            "administrators. This can be disabled using \"none\", but that is "
            "not recommended."),
    },
    {
        "PCMK_" PCMK__ENV_LOGFILE, NULL, "string", pcmk__option_local,
        NULL,
        CRM_LOG_DIR "/pacemaker.log", NULL,
        N_("Log file for detail log messages"),
        N_("Unless set to none, more detailed log messages will be sent to the "
            "specified file (in addition to the system log, if enabled). These "
            "messages may have extended information, and will include messages "
            "of info severity. This log is of more use to developers and "
            "advanced system administrators, and when reporting problems."),
    },
    {
        "PCMK_" PCMK__ENV_LOGFILE_MODE, NULL, "string", pcmk__option_local,
        NULL,
        "0660", NULL,
        N_("Mode for detail log file"),
        N_("Pacemaker will set the permissions on the detail log to this value "
           "(see chmod(1))"),
    },
    {
        "PCMK_" PCMK__ENV_LOGPRIORITY, NULL, "select", pcmk__option_local,
        "emerg, alert, crit, error, warning, notice, info, debug",
        "notice", NULL,
        N_("Log priority for syslog or systemd-journald"),
        N_("Unless system logging is disabled using PCMK_logfacility=none, "
            "messages of the specified log severity and higher will be sent "
            "to the system log. The default is appropriate for most "
            "installations."),
    },
    {
        "PCMK_" PCMK__ENV_STDERR, NULL, "boolean", pcmk__option_local,
        NULL,
        "no", NULL,
        N_("*** Advanced Use Only ***"),
        N_("Whether to send daemon log messages to stderr. This would be "
            "useful only during troubleshooting, when starting Pacemaker "
            "manually on the command line. Setting this option in the "
            "configuration file is pointless, since the file is not read when "
            "starting Pacemaker manually. However, it can be set directly as "
            "an environment variable on the command line."),
    },
    {
        "PCMK_" PCMK__ENV_TRACE_FILES, NULL, "string", pcmk__option_local,
        NULL,
        NULL, NULL,
        N_("*** Advanced Use Only ***"),
        N_("Send debug and trace severity messages from all functions in these "
            "(comma-separated) source file names to the detail log."),
    },
    {
        "PCMK_" PCMK__ENV_TRACE_FORMATS, NULL, "string", pcmk__option_local,
        NULL,
        NULL, NULL,
        N_("*** Advanced Use Only ***"),
        N_("Send trace severity messages that are generated by these (comma-"
            "separated) format strings in the source code to the detail log."),
    },
    {
        "PCMK_" PCMK__ENV_TRACE_FUNCTIONS, NULL, "string", pcmk__option_local,
        NULL,
        NULL, NULL,
        N_("*** Advanced Use Only ***"),
        N_("Send debug and trace severity messages from these (comma-"
            "separated) source code functions to the detail log."),
    },
    {
        "PCMK_" PCMK__ENV_TRACE_TAGS, NULL, "string", pcmk__option_local,
        NULL,
        NULL, NULL,
        N_("*** Advanced Use Only ***"),
        N_("Send debug and trace severity messages related to these (comma-"
            "separated) resource IDs to the detail log."),
    },
};
