...
#ifndef OPTIONS_PRIVATE__H
#  define OPTIONS_PRIVATE__H
...
static const pcmk__cluster_option_t cluster_options[] = {
    {
        PCMK__OPT_DC_VERSION, NULL, "string", NULL,
    ...
    {
        PCMK__OPT_CLUSTER_NAME, NULL, "string", NULL,
        NULL, NULL,
        pcmk__opt_context_controld,
        N_("An arbitrary name for the cluster"),
        N_("This optional value is mostly for users' convenience as desired in "
    ...
    {
        PCMK__OPT_DC_DEADTIME, NULL, "time", NULL,
    ...
    {
        PCMK__OPT_CLUSTER_RECHECK_INTERVAL, NULL, "time",
    ...
    {
        PCMK__OPT_LOAD_THRESHOLD, NULL, "percentage", NULL,
    ...
    {
        PCMK__OPT_NODE_ACTION_LIMIT, NULL, "integer", NULL,
        "0", pcmk__valid_int,
        pcmk__opt_context_controld,
    ...
    {
        PCMK__OPT_FENCE_REACTION, NULL, "select", "stop, panic",
        "stop", NULL,
        pcmk__opt_context_controld,
    ...
    {
        PCMK__OPT_ELECTION_TIMEOUT, NULL, "time", NULL,
    ...
    {
        PCMK__OPT_SHUTDOWN_ESCALATION, NULL, "time", NULL,
    ...
    {
        PCMK__OPT_JOIN_INTEGRATION_TIMEOUT, "crmd-integration-timeout", "time",
            NULL,
    ...
    {
        PCMK__OPT_JOIN_FINALIZATION_TIMEOUT, "crmd-finalization-timeout",
            "time", NULL,
    ...
    {
        PCMK__OPT_TRANSITION_DELAY, "crmd-transition-delay", "time", NULL,
    ...
    {
        PCMK__OPT_STONITH_WATCHDOG_TIMEOUT, NULL, "time", NULL,
    ...
    {
        PCMK__OPT_STONITH_MAX_ATTEMPTS, NULL, "integer", NULL,
    ...
    },
    {
        ...
        pcmk__opt_context_controld|pcmk__opt_context_schedulerd,
    ...
    },
    {
        ...
        N_("The node elected Designated Controller (DC) will consider an "
            "action failed if it does not get a response from the node "
            "executing the action within this time (after considering the "
            "action's own timeout). The \"correct\" value will depend on the "
    ...
    },
    {
        ...
        N_("The \"correct\" value will depend on the speed and load of your "
            "network and cluster nodes. If set to 0, the cluster will impose "
            "a dynamically calculated limit when any node has a high load."),
    },
    {
...
static const pcmk__cluster_option_t stonith_instance_attrs[] = {
    {
        PCMK_STONITH_HOST_ARGUMENT, NULL, "string", NULL,
        "port", NULL,
        pcmk__opt_context_fenced,
        N_("*** Advanced Use Only *** "
    ...
    },
    {
        ...
        "", NULL,
        pcmk__opt_context_fenced,
        N_("A mapping of host names to ports numbers for devices that do not "
            "support host names."),
    ...
    },
    {
        ...
        "", NULL,
        pcmk__opt_context_fenced,
        N_("A list of machines controlled by this device (optional unless "
    ...
    },
    {
        ...
        N_("Use \"dynamic-list\" to query the device via the 'list' command. "
            "Use \"static-list\" to check the pcmk_host_list attribute. "
            "Use \"status\" to query the device via the 'status' command. "
            "Use \"none\" to assume every device can fence every node."),
    },
    {
