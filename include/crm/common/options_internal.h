 ...
 */
enum pcmk__opt_flags {
    pcmk__opt_none       = 0,           //!< No additional information
    pcmk__opt_based      = (1 << 0),    //!< In CIB manager metadata
    pcmk__opt_controld   = (1 << 1),    //!< In controller metadata
    pcmk__opt_schedulerd = (1 << 2),    //!< In scheduler metadata
};
