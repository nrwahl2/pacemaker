...
cluster_options_xml(pcmk__output_t *out, va_list args) {
    ...
    pcmk__output_create_xml_node(out, "cluster_options",
                                 PCMK__OPT_STONITH_ENABLED,
                                    bv(pcmk_sched_fencing_enabled),
                                 PCMK__OPT_SYMMETRIC_CLUSTER,
                                    bv(pcmk_sched_symmetric_cluster),
                                 PCMK__OPT_NO_QUORUM_POLICY, no_quorum_policy,
                                 PCMK__OPT_MAINTENANCE_MODE,
                                    bv(pcmk_sched_in_maintenance),
                                 PCMK__OPT_STOP_ALL_RESOURCES,
                                    bv(pcmk_sched_stop_all),
                                 PCMK__OPT_STONITH_TIMEOUT "-ms",
                                    stonith_timeout_str,
                                 PCMK__OPT_PRIORITY_FENCING_DELAY "-ms",
